...
def block_inception_a(inputs, scope=None, reuse=None):
  ...
  #The use of arg_scope is to give default values to te arguments of the layers in the list unless you override them
    with slim.arg_scope([slim.conv2d, slim.avg_pool2d, slim.max_pool2d], stride=1, padding='SAME'):
        with tf.variable_scope(scope, 'BlockInceptionA', [inputs], reuse=reuse):
            ...
            return tf.concat(axis=3, values=[branch_0, branch_1, branch_2, branch_3])  #Concatenate along the channels refer tf.stack
    ...
    with slim.arg_scope([slim.conv2d, slim.avg_pool2d, slim.max_pool2d], stride=1, padding='SAME'):
        with tf.variable_scope(scope, 'BlockReductionA', [inputs], reuse=reuse):
            with tf.variable_scope('Branch_0'):
                ...
                #The arguments here override the arguments given in slim.arg_scope
            with tf.variable_scope('Branch_1'):
            ...
            #How is concatenation possible here?
            ...
            with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d], stride = 1, padding = 'SAME'):
                ...
                with tf.variable_scope('Logits'):
                  # 8 x 8 x 1536
                    ...
                    net = slim.dropout(net, dropout_keep_prob = 0.5, scope = 'Dropout_1c')
                    logits = slim.fully_connected(net, num_classes,activation_fn=None,scope='Logits') 
                    """
